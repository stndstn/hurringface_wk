...
#modelname = "microsoft/Florence-2-base-ft"
#modelname = "microsoft/Florence-2-large"
#modelname = "microsoft/Florence-2-large-ft"
#modelname = "HuggingFaceM4/Florence-2-DocVQA"
...
model = AutoModelForCausalLM.from_pretrained(modelname, torch_dtype=torch_dtype, trust_remote_code=True).to(device)
#print(f"model: {model}")
